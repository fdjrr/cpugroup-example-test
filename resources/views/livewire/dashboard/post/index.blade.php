                    ...
                    <tr class="border-b odd:bg-white even:bg-gray-50 dark:border-gray-700 odd:dark:bg-gray-900 even:dark:bg-gray-800">
                        ...
                        <td class="px-6 py-4">
                            @if ($post->is_published)
                                <span class="me-2 rounded border border-green-400 bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-gray-700 dark:text-green-400">Published</span>
                            @else
                                <span class="me-2 rounded border border-gray-500 bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800 dark:bg-gray-700 dark:text-gray-400">Draft</span>
                            @endif
                        </td>
                        <td class="flex items-center px-6 py-4">
                            ...
                            <a class="font-medium text-red-600 ms-3 hover:underline dark:text-red-500" href="javascript:void(0)" wire:click="delete({{ $post->id }})">Remove</a>
                        </td>
                    </tr>
                @empty
